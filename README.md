...
> *Full-Stack Developer, Data Engineer, and ML Researcher focused on freelance and high-impact projects. I design and maintain robust ETL pipelines on AWS services — primarily Glue and Redshift — transforming complex, raw data into strategic assets for the business. On the ML side, I build predictive models and sentiment analysis systems using clean, scalable architectures. As a Full-Stack Developer, I work with Django and Laravel to build platforms, real-time APIs with WebSockets, and production deployments on Linux servers with NGINX and Docker. I'm driven by building quality software with a data-first vision and a results-oriented mindset.*
...
|---------|-------------|-------|
| 🤖 **ML Price Predictor** | University research: stochastic & predictive pricing models with hexagonal architecture and LLM FinBert for sentiment analysis via news APIs. | `Python` `FastAPI` `NoSQL` |
| ⚡ **Energy Statistical Models** | ETL pipeline over Colombian energy sector data using Polars. PostgreSQL storage, Docker Compose containerization. | `Polars` `PostgreSQL` `Docker` |
| 🛒 **Squash Urban E-commerce** | Full-Stack e-commerce platform for wholesale SQUASH with Laravel, Eloquent ORM, Blade. Deployed on Hostinger. | `Laravel` `Blade` `MySQL` |
| 🎮 **Drota — Multiplayer Game** | Real-time WebSocket API, JWT authentication, VPS deployment with domain and NGINX. | `Laravel` `WebSocket` `Linux VPS` |
...
### 🔧 Backend & Frameworks
<img src="https://skillicons.dev/icons?i=django,php,laravel,java,spring,hibernate&theme=dark" />

### 🌐 Frontend & Web
<img src="https://skillicons.dev/icons?i=html,css,js&theme=dark" />

### 🗄️ Databases & Tools
<img src="https://skillicons.dev/icons?i=mysql,mongodb,git,github,vscode,idea&theme=dark" />
...
- 🎓 **Systems Engineering** — Universidad Minuto de Dios *(In progress, 2026)*
- 🤖 **Robotics & Communication** — UNAL + Secretaría de Educación Distrital
- 🌐 **Networking Essentials / IoT** — Cisco Academy
- 💡 **Misión TIC** — Universidad Tecnológica de Pereira
- 🧠 **Programming Fundamentals** — UNAL Bogotá
